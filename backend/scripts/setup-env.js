...
const firebaseConfig = `# Backblaze B2 Configuration
...
console.log('Successfully created/updated .env file with Firebase configuration.');

// Now fix the private key formatting
const privateKey =
  '-----BEGIN PRIVATE KEY-----\n' +
  'MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQDPmQXN7jqJ1FJK\n' +
  'mSUwQxAGEM4aKR58NYQ2iAyiaRN6xlUgHOqHV/eSg62Cqg+lWGWZgHtw5TJP48g9\n' +
...
console.log('Successfully updated Firebase private key in .env file with proper formatting.');
