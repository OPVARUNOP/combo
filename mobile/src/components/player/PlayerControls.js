    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainControls}>
        ...
        <TouchableOpacity onPress={onPlayPause} style={styles.playButton}>
          <Icon name={isPlaying ? 'pause' : 'play-arrow'} size={48} color={colors.text.primary} />
        </TouchableOpacity>
      ...
      <View style={styles.secondaryControls}>
        <TouchableOpacity onPress={onQueue} style={styles.secondaryButton}>
          <Icon name='queue-music' size={20} color={colors.text.secondary} />
          <Text style={styles.secondaryButtonText}>Queue</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={onLyrics} style={styles.secondaryButton}>
          <Icon name='lyrics' size={20} color={colors.text.secondary} />
